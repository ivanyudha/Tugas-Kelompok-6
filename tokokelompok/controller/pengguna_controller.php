...
class PenggunaController {
    ...
    function pengguna_add_submit($data){
        ...
        $model->insert("pengguna", "id_pengguna, nama_pengguna, password, nama_depan, nama_belakang, no_hp, alamat, id_akses", "NULL, '$nama_pengguna', '$password', '$nama_depan', '$nama_belakang', '$no_hp', '$alamat', '$id_akses'");
    }
