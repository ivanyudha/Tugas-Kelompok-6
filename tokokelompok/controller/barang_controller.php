...
class BarangController {
    ...
    function barang_add_submit($data) {
        ...
        $stok = $data->get_stok(); // Pastikan variabel ini didefinisikan
    
        // Perbaiki parameter untuk fungsi insert
        $model->insert("barang", "id_barang, nama_barang, keterangan, satuan, stok","NULL, '$nama_barang', '$keterangan', '$satuan', '$stok'");
    }
    ...
    function barang_edit_submit($data) {
        ...
        // Pastikan pernyataan update sesuai dengan format yang benar
        $model->updateWhere("barang", "nama_barang = '$nama_barang', keterangan = '$keterangan', satuan = '$satuan', stok = '$stok'", "id_barang = '$id_barang'");
    }
